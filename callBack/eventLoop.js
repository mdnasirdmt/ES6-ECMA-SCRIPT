...
// 1. When does the event loop actually start? - Event loop, as the name suggests, 
// is a single-thread, loop that is `almost infinite`. It's always running and doing its job. ❤️
